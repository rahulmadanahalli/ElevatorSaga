        ...
        for (var i = 0; i < elevators.length; i++) {
            ...
            elevator.on("stopped_at_floor", function(floorNum) {
                if (floorNum == 0) { //if the elevator is on floor 1
                    if (floors_going_up.length != 0 && this.destinationQueue.length == 0){ //if the going up queue isn't empty and the destination queue is empty
                        this.destinationQueue = floors_going_up; //make destination queue the going up queue
                        this.destinationQueue.sort();
                    ...
                    if (floors_going_down.length != 0 && this.destinationQueue.length == 0){ //if the going down queue isn't empty and the destination queue is empty
                        this.destinationQueue = floors_going_down; //make destination queue the going down queue
                        this.destinationQueue.sort();
                        this.destinationQueue.reverse();
